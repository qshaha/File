	...
	<div class="layui-layout layui-layout-admin">
		...
		<div id="headtable" class="layui-header" style="background-color: white;">
			<table class="layui-table" lay-skin="nob">
				...
				<tbody>
					<tr>
						<td></td>
						<td><p>当前位置：<a href="${pageContext.request.contextPath}/index2.jsp">首页</a>>>注册</p></td>
		...
		<div class="layui-main" style="width: 500px; margin: 0 auto; margin-bottom: 100px;">
			<form class="layui-form" action="${pageContext.request.contextPath}/patient/register" method="post">
				...
				<div class="layui-form-item">
					<label id="sexlabel" class="layui-form-label" style="width: auto;"><i class="layui-icon layui-icon-male" style="font-size: 38px;"></i></label>
					<div id="sexdiv" class="layui-input-inline" style="float: none;">
						<input type="radio" name="sex" value="男" title="男" checked="checked" />
						<input type="radio" name="sex" value="女" title="女" />
					</div>
					<div class="layui-form-mid layui-word-aux" style="width: 200px; float: right;">*设置后无法更改！请谨慎填写</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label" style="width: auto;"><i class="layui-icon layui-icon-date" style="font-size: 38px;"></i></label>
					<div class="layui-input-inline" style="float: none;">
						<input id="birth" type="text" name="birth" required lay-verify="required" placeholder="请选择出生日期" autocomplete="off" readonly="readonly" class="layui-input" />
					</div>
					<div id="birtherro" class="layui-form-mid layui-word-aux" style="width: 200px; float: right;">*设置后无法更改！请谨慎填写</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					<label class="layui-form-label" style="width: auto;"><i class="layui-icon layui-icon-list" style="font-size: 38px;"></i></label>
					<div class="layui-input-inline">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="answer" required lay-verify="required" placeholder="请输入问题答案" autocomplete="off" class="layui-input" />
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label" style="width: auto;"><i class="layui-icon layui-icon-password" style="font-size: 38px;"></i></label>
					<div class="layui-input-inline">
						<input type="password" name="password" required lay-verify="required" placeholder="请设置账号密码" autocomplete="off" class="layui-input" />
					</div>
				</div>
				<div class="layui-form-item">
